...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><spring:message code="item.delete.confirm"/></h6>
        </div>
        <div class="card-body">
            <div class="chart-bar">
                <a href="<c:url value="/app/item/all"/>" class="btn btn-primary btn-icon-split btn-lg">
